class AnsiToHtmlConverter:
    ...
    It converts raw ANSI strings to HTML spans. No support (yet) for embedded links/MXP but it handles
    ANSI exceptionally well.

    Credit: Neil Stevens (https://github.com/stevensmedia/)
    Converted to Python by: Andrew Bastien (https://github.com/volundmush/)
    """
    ...
    def __init__(self, color_table=None):
        self.color_table = color_table or self.COLOR_TABLE
    ...
    def convert(self, text: str, mush_log: bool = False) -> str:
        ...
        ret = ""
        offset = 0
        state = self.State(self.color_table)
